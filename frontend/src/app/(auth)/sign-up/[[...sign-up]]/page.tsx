...
export default function SignUpPage() {
        ...
        <div style={{ background: 'hsl(var(--surface))', border: '1px solid hsl(var(--border))', borderRadius: 'var(--radius-2xl)', boxShadow: 'var(--shadow-float)', padding: '2.5rem 2rem' }}>
          ...
          {stage === 'form' && (
            <form onSubmit={handleRegister} noValidate>
              ...
              <button type="submit" disabled={loading || googleLoading} className="btn-save" style={{ width: '100%', justifyContent: 'center', fontSize: '0.9375rem', opacity: loading ? 0.7 : 1 }}>
 ...
 <div id="clerk-captcha" style={{ marginBottom: '1rem' }} />
              <button type="submit" disabled={loading} className="btn-save" style={{ width: '100%', justifyContent: 'center', fontSize: '0.9375rem', opacity: loading ? 0.7 : 1 }}>

...
/**
 * WhatsAppFloat — fixed, icon-only WhatsApp CTA.
 *
 * Sits bottom-right on every page (mount once in app/layout.tsx, outside
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center
                 rounded-full bg-gradient-to-br from-[hsl(142_60%_40%)] to-[hsl(142_62%_32%)]
                 text-white shadow-lg shadow-[hsl(142_60%_20%/0.28)]
                 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl
                 hover:shadow-[hsl(142_60%_20%/0.36)] motion-reduce:transition-none
    ...
    >
      <span className="relative flex h-full w-full items-center justify-center rounded-full">
        ...
        <span className="absolute right-0.5 top-0.5 flex h-3 w-3">
          ...
          <span className="relative inline-flex h-3 w-3 rounded-full bg-[hsl(120_60%_62%)] ring-2 ring-[hsl(142_62%_32%)]" />
        </span>
      </span>
    </a>
  )
